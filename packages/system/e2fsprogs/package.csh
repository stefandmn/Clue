...
PKG_DESCRIPTION="The filesystem utilities for the EXT2 filesystem, including e2fsck, mke2fs, dumpe2fs, fsck, and others."
...
post_makeinstall_target() {
	make -C lib/et LIBMODE=644 DESTDIR=$TARGET_SYSROOT install
