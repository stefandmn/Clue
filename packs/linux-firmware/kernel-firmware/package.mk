...
PKG_NEED_UNPACK="${SYSTEM}/${PACKAGES}/${PKG_NAME} ${SYSTEM}/devices/${DEVICE}/${PACKAGES}/${PKG_NAME}"
...
makeinstall_target() {
  ...
  FW_LISTS+=" ${SYSTEM}/config/kernel-firmware-any.dat ${SYSTEM}/config/kernel-firmware-${TARGET_ARCH}.dat"

  FW_LISTS+=" ${SYSTEM}/devices/${DEVICE}/config/kernel-firmware-any.dat ${SYSTEM}/devices/${DEVICE}/config/kernel-firmware-${TARGET_ARCH}.dat"
