...
ADDON_DIR="/clue/.kodi/addons/service.proftpd"
...
addon() {
	...
	cp $PKG_BUILD/.$TARGET_NAME/proftpd ${BUILDER_ADDON}/$PKG_ADDON_ID/bin
	cp $PKG_BUILD/.$TARGET_NAME/ftpwho ${BUILDER_ADDON}/$PKG_ADDON_ID/bin
	cp $PKG_BUILD/.$TARGET_NAME/ftptop ${BUILDER_ADDON}/$PKG_ADDON_ID/bin

	cp ${BUILDER}/whois*/mkpasswd ${BUILDER_ADDON}/$PKG_ADDON_ID/bin

	mkdir -p ${BUILDER_ADDON}/$PKG_ADDON_ID/locale
	cp $PKG_BUILD/.$TARGET_NAME/locale/* ${BUILDER_ADDON}/$PKG_ADDON_ID/locale
}
