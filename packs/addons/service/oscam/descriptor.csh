...
PKG_CMAKE_OPTS_TARGET="\
  `#Building` \
  -DLIBUSBDIR=$TARGET_SYSROOT/usr \
  -DOPTIONAL_INCLUDE_DIR=$TARGET_SYSROOT/usr/include \
  \
  `#Readers` \
...
addon() {
  mkdir -p ${BUILDER_ADDON}/$PKG_ADDON_ID/bin
    cp -P $PKG_BUILD/.$TARGET_NAME/oscam ${BUILDER_ADDON}/$PKG_ADDON_ID/bin
    cp -P $PKG_BUILD/.$TARGET_NAME/utils/list_smargo ${BUILDER_ADDON}/$PKG_ADDON_ID/bin
}
