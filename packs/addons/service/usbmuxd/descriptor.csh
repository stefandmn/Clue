...
PKG_DISCLAIMER="Additional data charges may occur. The Clue team doesn't take any resposibility for extra data charges."
...
addon() {
	...
	cp -P $PKG_BUILD/.$TARGET_NAME/src/usbmuxd ${BUILDER_ADDON}/$PKG_ADDON_ID/bin/
}
