...
PKG_CONFIGURE_OPTS_TARGET="--disable-static \
                           ...
                           --with-os-name="$DISTRO_NAME" \
                           --with-db-path="/clue/.kodi/userdata/addon_data/service.minidlna/db" \
...
addon() {
	...
	cp -P $PKG_BUILD/.install_pkg/usr/sbin/minidlnad ${BUILDER_ADDON}/$PKG_ADDON_ID/bin

	mkdir -p ${BUILDER_ADDON}/$PKG_ADDON_ID/lib
	cp -p $(get_build_dir libexif)/.install_pkg/usr/lib/libexif.so.12 ${BUILDER_ADDON}/$PKG_ADDON_ID/lib
}
