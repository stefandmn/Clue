...
post_makeinstall_target() {
	mkdir -p $TARGET_SYSROOT/usr/include/MediaInfo
	cp -aP ../../../Source/MediaInfo/* $TARGET_SYSROOT/usr/include/MediaInfo
	for i in Archive Audio Duplicate Export Image Multiple Reader Tag Text Video; do
		mkdir -p $TARGET_SYSROOT/usr/include/MediaInfo/$i/
		cp -aP ../../../Source/MediaInfo/$i/*.h $TARGET_SYSROOT/usr/include/MediaInfo/$i/
	done
