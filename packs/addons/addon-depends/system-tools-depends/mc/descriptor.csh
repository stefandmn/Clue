...
PKG_CONFIGURE_OPTS_TARGET=" \
  --datadir=/clue/.kodi/addons/virtual.system-tools/data \
  --libexecdir=/clue/.kodi/addons/virtual.system-tools/mclib \
  --with-homedir=/clue/.kodi/userdata/addon_data/virtual.system-tools \
  --sysconfdir=/clue/.kodi/addons/virtual.system-tools/etc \
  --with-screen=ncurses \
...
post_makeinstall_target() {
	rm -rf $INSTALL/clue/.kodi/addons/virtual.system-tools/data/locale
	rm -rf $INSTALL/clue/.kodi/addons/virtual.system-tools/data/mc/help/mc.hlp.*
