...
post_makeinstall_target() {
	sed -i "s|pkgincludedir=.*|pkgincludedir=\'$TARGET_SYSROOT/usr/include/mysql\'|" scripts/mysql_config
	sed -i "s|pkglibdir=.*|pkglibdir=\'$TARGET_SYSROOT/usr/lib/mysql\'|" scripts/mysql_config
	cp scripts/mysql_config $TARGET_SYSROOT/usr/bin
